...
val get_args_information:
  Callable_info.t structure ptr -> (string * string * string) option
  -> string list -> args
...
val append_ctypes_function_bindings:
  string -> Function_info.t structure ptr -> (string * string * string) option
  -> Binding_utils.Sources.t -> string list -> unit
