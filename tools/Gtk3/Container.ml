...
let add =
  foreign "gtk_container_add" (t_typ @-> ptr Widget.t_typ @-> returning (void))
let check_resize =
  foreign "gtk_container_check_resize" (t_typ @-> returning (void))
let child_get_property =
  foreign "gtk_container_child_get_property" (t_typ @-> ptr Widget.t_typ @-> string @-> ptr Value.t_typ @-> returning (void))
let child_notify =
  foreign "gtk_container_child_notify" (t_typ @-> ptr Widget.t_typ @-> string @-> returning (void))
let child_notify_by_pspec =
  foreign "gtk_container_child_notify_by_pspec" (t_typ @-> ptr Widget.t_typ @-> ptr Param_spec.t_typ @-> returning (void))
let child_set_property =
  foreign "gtk_container_child_set_property" (t_typ @-> ptr Widget.t_typ @-> string @-> ptr Value.t_typ @-> returning (void))
...
let get_focus_child =
  foreign "gtk_container_get_focus_child" (t_typ @-> returning (ptr_opt Widget.t_typ))
let get_focus_hadjustment =
  foreign "gtk_container_get_focus_hadjustment" (t_typ @-> returning (ptr_opt Adjustment.t_typ))
let get_focus_vadjustment =
  foreign "gtk_container_get_focus_vadjustment" (t_typ @-> returning (ptr_opt Adjustment.t_typ))
let get_path_for_child =
  foreign "gtk_container_get_path_for_child" (t_typ @-> ptr Widget.t_typ @-> returning (ptr Widget_path.t_typ))
let get_resize_mode =
  foreign "gtk_container_get_resize_mode" (t_typ @-> returning (Resize_mode.t_view))
let propagate_draw =
  foreign "gtk_container_propagate_draw" (t_typ @-> ptr Widget.t_typ @-> ptr Context.t_typ @-> returning (void))
let remove =
  foreign "gtk_container_remove" (t_typ @-> ptr Widget.t_typ @-> returning (void))
let resize_children =
...
let set_focus_child =
  foreign "gtk_container_set_focus_child" (t_typ @-> ptr_opt Widget.t_typ @-> returning (void))
let set_focus_hadjustment =
  foreign "gtk_container_set_focus_hadjustment" (t_typ @-> ptr Adjustment.t_typ @-> returning (void))
let set_focus_vadjustment =
  foreign "gtk_container_set_focus_vadjustment" (t_typ @-> ptr Adjustment.t_typ @-> returning (void))
