...
let create =
  foreign "gtk_application_window_new" (Application.t_typ @-> returning (Widget.t_typ))
let get_help_overlay =
  foreign "gtk_application_window_get_help_overlay" (t_typ @-> returning (Shortcuts_window.t_typ))
let get_id =
...
let set_help_overlay =
  foreign "gtk_application_window_set_help_overlay" (t_typ @-> Shortcuts_window.t_typ @-> returning (void))
