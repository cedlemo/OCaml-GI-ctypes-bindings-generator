...
let create =
  foreign "gtk_tool_button_new" (Widget.t_typ @-> string_opt @-> returning (Tool_item.t_typ))
let create_from_stock =
  foreign "gtk_tool_button_new_from_stock" (string @-> returning (Tool_item.t_typ))
let get_icon_name =
  foreign "gtk_tool_button_get_icon_name" (t_typ @-> returning (string_opt))
let get_icon_widget =
  foreign "gtk_tool_button_get_icon_widget" (t_typ @-> returning (Widget.t_typ))
let get_label =
  foreign "gtk_tool_button_get_label" (t_typ @-> returning (string_opt))
let get_label_widget =
  foreign "gtk_tool_button_get_label_widget" (t_typ @-> returning (Widget.t_typ))
let get_stock_id =
...
let set_icon_widget =
  foreign "gtk_tool_button_set_icon_widget" (t_typ @-> Widget.t_typ @-> returning (void))
let set_label =
  foreign "gtk_tool_button_set_label" (t_typ @-> string_opt @-> returning (void))
let set_label_widget =
  foreign "gtk_tool_button_set_label_widget" (t_typ @-> Widget.t_typ @-> returning (void))
let set_stock_id =
