...
val create_for_pixbuf :
  Icon_theme.t ptr -> Pixbuf.t ptr -> t ptr
...
val is_symbolic :
  t -> bool
val load_icon :
  t -> (Pixbuf.t ptr option, Error.t structure ptr option) result
...
val load_surface :
  t -> Window.t ptr option -> (Surface.t structure ptr option, Error.t structure ptr option) result
val load_symbolic :
  t -> RGBA.t structure ptr -> RGBA.t structure ptr option -> RGBA.t structure ptr option -> RGBA.t structure ptr option -> (Pixbuf.t ptr option * bool, Error.t structure ptr option) result
...
val load_symbolic_for_context :
  t -> Style_context.t ptr -> (Pixbuf.t ptr option * bool, Error.t structure ptr option) result
...
val load_symbolic_for_style :
  t -> Style.t ptr -> State_type.t -> (Pixbuf.t ptr option * bool, Error.t structure ptr option) result
