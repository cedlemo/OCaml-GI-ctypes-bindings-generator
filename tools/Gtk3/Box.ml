...
let create =
  foreign "gtk_box_new" (Orientation.t_view @-> int32_t @-> returning (ptr Widget.t_typ))
...
let get_center_widget =
  foreign "gtk_box_get_center_widget" (t_typ @-> returning (ptr_opt Widget.t_typ))
let get_homogeneous =
  foreign "gtk_box_get_homogeneous" (t_typ @-> returning (bool))
let get_spacing =
  foreign "gtk_box_get_spacing" (t_typ @-> returning (int32_t))
let pack_end =
  foreign "gtk_box_pack_end" (t_typ @-> ptr Widget.t_typ @-> bool @-> bool @-> uint32_t @-> returning (void))
let pack_start =
  foreign "gtk_box_pack_start" (t_typ @-> ptr Widget.t_typ @-> bool @-> bool @-> uint32_t @-> returning (void))
let query_child_packing self child =
  let query_child_packing_raw =
    foreign "gtk_box_query_child_packing" (t_typ @-> ptr Widget.t_typ @-> ptr (bool) @-> ptr (bool) @-> ptr (uint32_t) @-> ptr (Pack_type.t_view) @-> returning (void))
  in
...
let reorder_child =
  foreign "gtk_box_reorder_child" (t_typ @-> ptr Widget.t_typ @-> int32_t @-> returning (void))
...
let set_center_widget =
  foreign "gtk_box_set_center_widget" (t_typ @-> ptr_opt Widget.t_typ @-> returning (void))
let set_child_packing =
  foreign "gtk_box_set_child_packing" (t_typ @-> ptr Widget.t_typ @-> bool @-> bool @-> uint32_t @-> Pack_type.t_view @-> returning (void))
let set_homogeneous =
