...
let create =
  foreign "gtk_frame_new" (string_opt @-> returning (ptr Widget.t_typ))
let get_label =
...
let get_label_widget =
  foreign "gtk_frame_get_label_widget" (t_typ @-> returning (ptr_opt Widget.t_typ))
let get_shadow_type =
...
let set_label_widget =
  foreign "gtk_frame_set_label_widget" (t_typ @-> ptr_opt Widget.t_typ @-> returning (void))
let set_shadow_type =
