...
val f_widget_path_pspecs: (SList.t structure (* unit *) ptr, t structure) field
val f_widget_class_pspecs: (SList.t structure (* unit *) ptr, t structure) field
val f_class_branch_pspecs: (SList.t structure (* unit *) ptr, t structure) field
...
val activate :
  t structure ptr -> Unsigned.uint32 -> Modifier_type.t_list -> Object.t ptr -> bool
val add_path :
