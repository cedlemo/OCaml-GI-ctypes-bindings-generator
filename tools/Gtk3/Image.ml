...
let create =
  foreign "gtk_image_new" (void @-> returning (ptr Widget.t_typ))
let create_from_animation =
  foreign "gtk_image_new_from_animation" (ptr Pixbuf_animation.t_typ @-> returning (ptr Widget.t_typ))
let create_from_file =
  foreign "gtk_image_new_from_file" (string @-> returning (ptr Widget.t_typ))
(*Not implemented gtk_image_new_from_gicon type interface not implemented*)
let create_from_icon_name =
  foreign "gtk_image_new_from_icon_name" (string_opt @-> int32_t @-> returning (ptr Widget.t_typ))
let create_from_icon_set =
  foreign "gtk_image_new_from_icon_set" (ptr Icon_set.t_typ @-> int32_t @-> returning (ptr Widget.t_typ))
let create_from_pixbuf =
  foreign "gtk_image_new_from_pixbuf" (ptr_opt Pixbuf.t_typ @-> returning (ptr Widget.t_typ))
let create_from_resource =
  foreign "gtk_image_new_from_resource" (string @-> returning (ptr Widget.t_typ))
let create_from_stock =
  foreign "gtk_image_new_from_stock" (string @-> int32_t @-> returning (ptr Widget.t_typ))
let create_from_surface =
  foreign "gtk_image_new_from_surface" (ptr_opt Surface.t_typ @-> returning (ptr Widget.t_typ))
let clear =
  foreign "gtk_image_clear" (t_typ @-> returning (void))
let get_animation =
  foreign "gtk_image_get_animation" (t_typ @-> returning (ptr_opt Pixbuf_animation.t_typ))
...
let get_icon_set self =
  ...
  (icon_set, size)
let get_pixbuf =
  foreign "gtk_image_get_pixbuf" (t_typ @-> returning (ptr_opt Pixbuf.t_typ))
let get_pixel_size =
...
let set_from_animation =
  foreign "gtk_image_set_from_animation" (t_typ @-> ptr Pixbuf_animation.t_typ @-> returning (void))
let set_from_file =
...
let set_from_pixbuf =
  foreign "gtk_image_set_from_pixbuf" (t_typ @-> ptr_opt Pixbuf.t_typ @-> returning (void))
