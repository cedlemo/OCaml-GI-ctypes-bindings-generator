...
let create =
  foreign "gtk_check_menu_item_new" (void @-> returning (Widget.t_typ))
let create_with_label =
  foreign "gtk_check_menu_item_new_with_label" (string @-> returning (Widget.t_typ))
let create_with_mnemonic =
  foreign "gtk_check_menu_item_new_with_mnemonic" (string @-> returning (Widget.t_typ))
let get_active =
