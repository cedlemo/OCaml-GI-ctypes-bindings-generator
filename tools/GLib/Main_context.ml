...
let create =
  foreign "g_main_context_new" (void @-> returning (ptr t_typ))
let acquire =
...
let default =
  foreign "g_main_context_default" (void @-> returning (ptr t_typ))
let get_thread_default =
  foreign "g_main_context_get_thread_default" (void @-> returning (ptr t_typ))
let ref_thread_default =
  foreign "g_main_context_ref_thread_default" (void @-> returning (ptr t_typ))
