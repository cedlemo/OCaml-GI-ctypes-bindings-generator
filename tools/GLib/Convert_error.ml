...
type t = No_conversion | Illegal_sequence | Failed | Partial_input | Bad_uri | Not_absolute_path | No_memory | Embedded_nul
...
let of_value v =
  ...
  else if v = Unsigned.UInt32.of_int 7 then Embedded_nul
...
let to_value = function
  ...
  | Embedded_nul -> Unsigned.UInt32.of_int 7
