...
(*Not implemented g_string_append_unichar type unichar not implemented*)
...
(*Not implemented g_string_insert_unichar type unichar not implemented*)
val overwrite :
...
val prepend_len :
  t structure ptr -> string -> int64 -> t structure ptr
(*Not implemented g_string_prepend_unichar type unichar not implemented*)
val set_size :
