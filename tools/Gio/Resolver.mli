...
val lookup_by_name :
  t -> string -> Cancellable.t -> (List.t structure (* Inet_address.t *) ptr option, Error.t structure ptr option) result
...
val lookup_records :
  t -> string -> Resolver_record_type.t -> Cancellable.t -> (List.t structure (* Variant.t structure *) ptr option, Error.t structure ptr option) result
...
val lookup_service :
  t -> string -> string -> string -> Cancellable.t -> (List.t structure (* Srv_target.t structure *) ptr option, Error.t structure ptr option) result
