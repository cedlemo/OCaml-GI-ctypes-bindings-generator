...
val communicate :
  t -> Bytes.t structure ptr option -> Cancellable.t ptr option -> (bool * Bytes.t structure ptr option * Bytes.t structure ptr option, Error.t structure ptr option) result
...
val communicate_utf8 :
  t -> string option -> Cancellable.t ptr option -> (bool * string option * string option, Error.t structure ptr option) result
