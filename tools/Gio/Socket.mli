...
val create :
  Socket_family.t -> Socket_type.t -> Socket_protocol.t -> (t ptr option, Error.t structure ptr option) result
val create_from_fd :
  int32 -> (t ptr option, Error.t structure ptr option) result
val accept :
  t -> Cancellable.t ptr option -> (t ptr option, Error.t structure ptr option) result
val bind :
  t -> Socket_address.t ptr -> bool -> (bool, Error.t structure ptr option) result
...
val condition_timed_wait :
  t -> IOCondition.t_list -> int64 -> Cancellable.t ptr option -> (bool, Error.t structure ptr option) result
val condition_wait :
  t -> IOCondition.t_list -> Cancellable.t ptr option -> (bool, Error.t structure ptr option) result
val connect :
  t -> Socket_address.t ptr -> Cancellable.t ptr option -> (bool, Error.t structure ptr option) result
val connection_factory_create_connection :
  t -> Socket_connection.t ptr
...
val get_broadcast :
  t -> bool
val get_credentials :
  t -> (Credentials.t ptr option, Error.t structure ptr option) result
val get_family :
  t -> Socket_family.t
val get_fd :
  t -> int32
...
val get_local_address :
  t -> (Socket_address.t ptr option, Error.t structure ptr option) result
...
val join_multicast_group :
  t -> Inet_address.t ptr -> bool -> string option -> (bool, Error.t structure ptr option) result
val join_multicast_group_ssm :
  t -> Inet_address.t ptr -> Inet_address.t ptr option -> string option -> (bool, Error.t structure ptr option) result
