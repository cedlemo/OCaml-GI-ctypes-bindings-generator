...
val read_byte :
  t -> Cancellable.t -> (Unsigned.uint8, Error.t structure ptr option) result
val read_int16 :
  t -> Cancellable.t -> (int, Error.t structure ptr option) result
val read_int32 :
  t -> Cancellable.t -> (int32, Error.t structure ptr option) result
val read_int64 :
  t -> Cancellable.t -> (int64, Error.t structure ptr option) result
...
val read_line_utf8 :
  t -> Cancellable.t -> (string option * Unsigned.uint64, Error.t structure ptr option) result
val read_uint16 :
  t -> Cancellable.t -> (Unsigned.uint16, Error.t structure ptr option) result
val read_uint32 :
  t -> Cancellable.t -> (Unsigned.uint32, Error.t structure ptr option) result
val read_uint64 :
  t -> Cancellable.t -> (Unsigned.uint64, Error.t structure ptr option) result
val read_until :
  t -> string -> Cancellable.t -> (string option * Unsigned.uint64, Error.t structure ptr option) result
...
val read_upto :
  t -> string -> int64 -> Cancellable.t -> (string option * Unsigned.uint64, Error.t structure ptr option) result
