...
let create =
  foreign "g_menu_item_new" (string_opt @-> string_opt @-> returning (t_typ))
let create_from_model =
  foreign "g_menu_item_new_from_model" (Menu_model.t_typ @-> int32_t @-> returning (t_typ))
let create_section =
  foreign "g_menu_item_new_section" (string_opt @-> Menu_model.t_typ @-> returning (t_typ))
let create_submenu =
  foreign "g_menu_item_new_submenu" (string_opt @-> Menu_model.t_typ @-> returning (t_typ))
...
let get_link =
  foreign "g_menu_item_get_link" (t_typ @-> string @-> returning (Menu_model.t_typ))
...
let set_link =
  foreign "g_menu_item_set_link" (t_typ @-> string @-> Menu_model.t_typ @-> returning (void))
let set_section =
  foreign "g_menu_item_set_section" (t_typ @-> Menu_model.t_typ @-> returning (void))
let set_submenu =
  foreign "g_menu_item_set_submenu" (t_typ @-> Menu_model.t_typ @-> returning (void))
