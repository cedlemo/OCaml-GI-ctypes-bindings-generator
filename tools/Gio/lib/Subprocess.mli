...
val communicate :
  t -> Bytes.t structure ptr option -> Cancellable.t -> (bool * Bytes.t structure ptr * Bytes.t structure ptr, Error.t structure ptr option) result
...
val communicate_utf8 :
  t -> string option -> Cancellable.t -> (bool * string * string, Error.t structure ptr option) result
