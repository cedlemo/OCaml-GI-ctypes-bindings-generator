...
val lookup_certificates_issued_by :
  t -> Byte_array.t structure ptr -> Tls_interaction.t -> Tls_database_lookup_flags.t -> Cancellable.t -> (List.t structure ptr option, Error.t structure ptr option) result
