...
let create =
  foreign "g_dbus_object_skeleton_new" (string @-> returning (t_typ))
let add_interface =
  foreign "g_dbus_object_skeleton_add_interface" (t_typ @-> DBus_interface_skeleton.t_typ @-> returning (void))
let flush =
  foreign "g_dbus_object_skeleton_flush" (t_typ @-> returning (void))
let remove_interface =
  foreign "g_dbus_object_skeleton_remove_interface" (t_typ @-> DBus_interface_skeleton.t_typ @-> returning (void))
