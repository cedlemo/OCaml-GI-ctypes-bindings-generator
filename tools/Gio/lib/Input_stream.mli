...
val read_bytes :
  t -> Unsigned.uint64 -> Cancellable.t -> (Bytes.t structure ptr option, Error.t structure ptr option) result
...
val skip :
  t -> Unsigned.uint64 -> Cancellable.t -> (int64, Error.t structure ptr option) result
