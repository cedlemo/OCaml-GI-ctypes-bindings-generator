...
val create_for_address_sync :
  string -> DBus_connection_flags.t_list -> DBus_auth_observer.t ptr option -> Cancellable.t ptr option -> (t ptr option, Error.t structure ptr option) result
val create_sync :
  IOStream.t ptr -> string option -> DBus_connection_flags.t_list -> DBus_auth_observer.t ptr option -> Cancellable.t ptr option -> (t ptr option, Error.t structure ptr option) result
...
val call_sync :
  t -> string option -> string -> string -> string -> Variant.t structure ptr option -> Variant_type.t structure ptr option -> DBus_call_flags.t_list -> int32 -> Cancellable.t ptr option -> (Variant.t structure ptr option, Error.t structure ptr option) result
...
val call_with_unix_fd_list_sync :
  t -> string option -> string -> string -> string -> Variant.t structure ptr option -> Variant_type.t structure ptr option -> DBus_call_flags.t_list -> int32 -> Unix_fdlist.t ptr option -> Cancellable.t ptr option -> (Variant.t structure ptr option * Unix_fdlist.t ptr, Error.t structure ptr option) result
...
val export_menu_model :
  t -> string -> Menu_model.t ptr -> (Unsigned.uint32, Error.t structure ptr option) result
...
val send_message :
  t -> DBus_message.t ptr -> DBus_send_message_flags.t_list -> (bool * Unsigned.uint32, Error.t structure ptr option) result
...
val send_message_with_reply_sync :
  t -> DBus_message.t ptr -> DBus_send_message_flags.t_list -> int32 -> Cancellable.t ptr option -> (DBus_message.t ptr option * Unsigned.uint32, Error.t structure ptr option) result
