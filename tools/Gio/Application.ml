...
let set_option_context_description =
  foreign "g_application_set_option_context_description" (t_typ @-> string_opt @-> returning (void))
let set_option_context_parameter_string =
  foreign "g_application_set_option_context_parameter_string" (t_typ @-> string_opt @-> returning (void))
let set_option_context_summary =
  foreign "g_application_set_option_context_summary" (t_typ @-> string_opt @-> returning (void))
