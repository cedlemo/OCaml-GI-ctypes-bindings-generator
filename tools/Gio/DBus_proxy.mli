...
val create_for_bus_sync :
  Bus_type.t -> DBus_proxy_flags.t_list -> DBus_interface_info.t structure ptr option -> string -> string -> string -> Cancellable.t ptr option -> (t ptr option, Error.t structure ptr option) result
val create_sync :
  DBus_connection.t ptr -> DBus_proxy_flags.t_list -> DBus_interface_info.t structure ptr option -> string option -> string -> string -> Cancellable.t ptr option -> (t ptr option, Error.t structure ptr option) result
...
val call_sync :
  t -> string -> Variant.t structure ptr option -> DBus_call_flags.t_list -> int32 -> Cancellable.t ptr option -> (Variant.t structure ptr option, Error.t structure ptr option) result
...
val call_with_unix_fd_list_sync :
  t -> string -> Variant.t structure ptr option -> DBus_call_flags.t_list -> int32 -> Unix_fdlist.t ptr option -> Cancellable.t ptr option -> (Variant.t structure ptr option * Unix_fdlist.t ptr, Error.t structure ptr option) result
