...
let get_description =
  foreign "g_settings_schema_key_get_description" (ptr t_typ @-> returning (string_opt))
let get_name =
  foreign "g_settings_schema_key_get_name" (ptr t_typ @-> returning (string_opt))
let get_range =
  foreign "g_settings_schema_key_get_range" (ptr t_typ @-> returning (ptr Variant.t_typ))
let get_summary =
  foreign "g_settings_schema_key_get_summary" (ptr t_typ @-> returning (string_opt))
let get_value_type =
