...
val iter_add_class:
  t structure -> int32 -> string -> unit
val iter_add_region:
  t structure -> int32 -> string -> Region_flags.t_list -> unit
val iter_clear_classes:
  t structure -> int32 -> unit
val iter_clear_regions:
  t structure -> int32 -> unit
val iter_get_name:
  t structure -> int32 -> string option
...
val iter_get_sibling_index:
  t structure -> int32 -> Unsigned.uint32
val iter_get_siblings:
  t structure -> int32 -> t structure ptr
val iter_get_state:
  t structure -> int32 -> State_flags.t_list
val iter_has_class:
  t structure -> int32 -> string -> bool
val iter_has_name:
  t structure -> int32 -> string -> bool
val iter_has_qclass:
  t structure -> int32 -> Unsigned.uint32 -> bool
val iter_has_qname:
  t structure -> int32 -> Unsigned.uint32 -> bool
val iter_has_qregion :
  t structure -> int32 -> Unsigned.uint32 -> (bool * Region_flags.t_list)
val iter_has_region :
  t structure -> int32 -> string -> (bool * Region_flags.t_list)
val iter_list_classes:
  t structure -> int32 -> SList.t structure ptr
