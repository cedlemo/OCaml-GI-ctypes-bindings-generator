...
let create =
  foreign "gtk_stack_new" (void @-> returning (Widget.t_typ))
let add_named =
  foreign "gtk_stack_add_named" (t_typ @-> Widget.t_typ @-> string @-> returning (void))
let add_titled =
  foreign "gtk_stack_add_titled" (t_typ @-> Widget.t_typ @-> string @-> string @-> returning (void))
let get_child_by_name =
  foreign "gtk_stack_get_child_by_name" (t_typ @-> string @-> returning (Widget.t_typ))
...
let get_visible_child =
  foreign "gtk_stack_get_visible_child" (t_typ @-> returning (Widget.t_typ))
...
let set_visible_child =
  foreign "gtk_stack_set_visible_child" (t_typ @-> Widget.t_typ @-> returning (void))
