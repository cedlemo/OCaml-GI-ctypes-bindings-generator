...
let create =
  foreign "gtk_tool_item_group_new" (string @-> returning (Widget.t_typ))
let get_collapsed =
  foreign "gtk_tool_item_group_get_collapsed" (t_typ @-> returning (bool))
let get_drop_item =
  foreign "gtk_tool_item_group_get_drop_item" (t_typ @-> int32_t @-> int32_t @-> returning (Tool_item.t_typ))
let get_ellipsize =
...
let get_item_position =
  foreign "gtk_tool_item_group_get_item_position" (t_typ @-> Tool_item.t_typ @-> returning (int32_t))
let get_label =
  foreign "gtk_tool_item_group_get_label" (t_typ @-> returning (string_opt))
let get_label_widget =
  foreign "gtk_tool_item_group_get_label_widget" (t_typ @-> returning (Widget.t_typ))
let get_n_items =
  foreign "gtk_tool_item_group_get_n_items" (t_typ @-> returning (uint32_t))
let get_nth_item =
  foreign "gtk_tool_item_group_get_nth_item" (t_typ @-> uint32_t @-> returning (Tool_item.t_typ))
let insert =
  foreign "gtk_tool_item_group_insert" (t_typ @-> Tool_item.t_typ @-> int32_t @-> returning (void))
let set_collapsed =
...
let set_item_position =
  foreign "gtk_tool_item_group_set_item_position" (t_typ @-> Tool_item.t_typ @-> int32_t @-> returning (void))
let set_label =
  foreign "gtk_tool_item_group_set_label" (t_typ @-> string @-> returning (void))
let set_label_widget =
  foreign "gtk_tool_item_group_set_label_widget" (t_typ @-> Widget.t_typ @-> returning (void))
