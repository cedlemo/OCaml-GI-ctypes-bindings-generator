...
let get_preferred_height self =
  ...
  (minimum_height, natural_height)let get_preferred_height_for_width self width =
  ...
  let minimum_height = !@ minimum_height_ptr in
  let natural_height = !@ natural_height_ptr in
  (minimum_height, natural_height)let get_preferred_width self =
  ...
  let minimum_width = !@ minimum_width_ptr in
  let natural_width = !@ natural_width_ptr in
  (minimum_width, natural_width)let push_preferred_height =
