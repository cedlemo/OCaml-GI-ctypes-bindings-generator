...
let get_default_style =
  foreign "gtk_widget_get_default_style" (void @-> returning (Style.t_typ))
...
let add_accelerator =
  foreign "gtk_widget_add_accelerator" (t_typ @-> string @-> Accel_group.t_typ @-> uint32_t @-> Modifier_type.t_list_view @-> Accel_flags.t_list_view @-> returning (void))
let add_device_events =
  foreign "gtk_widget_add_device_events" (t_typ @-> Device.t_typ @-> Event_mask.t_list_view @-> returning (void))
let add_events =
  foreign "gtk_widget_add_events" (t_typ @-> int32_t @-> returning (void))
let add_mnemonic_label =
  foreign "gtk_widget_add_mnemonic_label" (t_typ @-> t_typ @-> returning (void))
...
let create_pango_layout =
  foreign "gtk_widget_create_pango_layout" (t_typ @-> string_opt @-> returning (Layout.t_typ))
let destroy =
  foreign "gtk_widget_destroy" (t_typ @-> returning (void))
let destroyed self widget_pointer =
  let destroyed_raw =
    foreign "gtk_widget_destroyed" (t_typ @-> ptr (t_typ) @-> returning (void))
  in
...
let drag_dest_find_target =
  foreign "gtk_drag_dest_find_target" (t_typ @-> Drag_context.t_typ @-> ptr_opt Target_list.t_typ @-> returning (ptr Atom.t_typ))
...
let drag_dest_set_proxy =
  foreign "gtk_drag_dest_set_proxy" (t_typ @-> Window.t_typ @-> Drag_protocol.t_view @-> bool @-> returning (void))
...
let drag_get_data =
  foreign "gtk_drag_get_data" (t_typ @-> Drag_context.t_typ @-> ptr Atom.t_typ @-> uint32_t @-> returning (void))
let drag_highlight =
...
let drag_source_set_icon_pixbuf =
  foreign "gtk_drag_source_set_icon_pixbuf" (t_typ @-> Pixbuf.t_typ @-> returning (void))
...
let get_accessible =
  foreign "gtk_widget_get_accessible" (t_typ @-> returning (Object.t_typ))
...
let get_device_enabled =
  foreign "gtk_widget_get_device_enabled" (t_typ @-> Device.t_typ @-> returning (bool))
let get_device_events =
  foreign "gtk_widget_get_device_events" (t_typ @-> Device.t_typ @-> returning (Event_mask.t_list_view))
let get_direction =
  foreign "gtk_widget_get_direction" (t_typ @-> returning (Text_direction.t_view))
let get_display =
  foreign "gtk_widget_get_display" (t_typ @-> returning (Display.t_typ))
...
let get_font_map =
  foreign "gtk_widget_get_font_map" (t_typ @-> returning (Font_map.t_typ))
let get_font_options =
  foreign "gtk_widget_get_font_options" (t_typ @-> returning (ptr_opt Font_options.t_typ))
let get_frame_clock =
  foreign "gtk_widget_get_frame_clock" (t_typ @-> returning (Frame_clock.t_typ))
let get_halign =
...
let get_modifier_style =
  foreign "gtk_widget_get_modifier_style" (t_typ @-> returning (Rc_style.t_typ))
let get_name =
...
let get_pango_context =
  foreign "gtk_widget_get_pango_context" (t_typ @-> returning (Context.t_typ))
let get_parent =
  foreign "gtk_widget_get_parent" (t_typ @-> returning (t_typ))
let get_parent_window =
  foreign "gtk_widget_get_parent_window" (t_typ @-> returning (Window.t_typ))
let get_path =
...
let get_screen =
  foreign "gtk_widget_get_screen" (t_typ @-> returning (Screen.t_typ))
let get_sensitive =
  foreign "gtk_widget_get_sensitive" (t_typ @-> returning (bool))
let get_settings =
  foreign "gtk_widget_get_settings" (t_typ @-> returning (Settings.t_typ))
...
let get_style =
  foreign "gtk_widget_get_style" (t_typ @-> returning (Style.t_typ))
let get_style_context =
  foreign "gtk_widget_get_style_context" (t_typ @-> returning (Style_context.t_typ))
...
let get_tooltip_window =
  foreign "gtk_widget_get_tooltip_window" (t_typ @-> returning (Window.t_typ))
let get_toplevel =
  foreign "gtk_widget_get_toplevel" (t_typ @-> returning (t_typ))
let get_valign =
...
let get_visual =
  foreign "gtk_widget_get_visual" (t_typ @-> returning (Visual.t_typ))
let get_window =
  foreign "gtk_widget_get_window" (t_typ @-> returning (Window.t_typ))
let grab_add =
...
let modify_style =
  foreign "gtk_widget_modify_style" (t_typ @-> Rc_style.t_typ @-> returning (void))
let modify_text =
...
let register_window =
  foreign "gtk_widget_register_window" (t_typ @-> Window.t_typ @-> returning (void))
let remove_accelerator =
  foreign "gtk_widget_remove_accelerator" (t_typ @-> Accel_group.t_typ @-> uint32_t @-> Modifier_type.t_list_view @-> returning (bool))
let remove_mnemonic_label =
  foreign "gtk_widget_remove_mnemonic_label" (t_typ @-> t_typ @-> returning (void))
let remove_tick_callback =
  foreign "gtk_widget_remove_tick_callback" (t_typ @-> uint32_t @-> returning (void))
let render_icon =
  foreign "gtk_widget_render_icon" (t_typ @-> string @-> int32_t @-> string_opt @-> returning (Pixbuf.t_typ))
let render_icon_pixbuf =
  foreign "gtk_widget_render_icon_pixbuf" (t_typ @-> string @-> int32_t @-> returning (Pixbuf.t_typ))
let reparent =
  foreign "gtk_widget_reparent" (t_typ @-> t_typ @-> returning (void))
let reset_rc_styles =
...
let set_accel_path =
  foreign "gtk_widget_set_accel_path" (t_typ @-> string_opt @-> Accel_group.t_typ @-> returning (void))
let set_allocation =
...
let set_device_enabled =
  foreign "gtk_widget_set_device_enabled" (t_typ @-> Device.t_typ @-> bool @-> returning (void))
let set_device_events =
  foreign "gtk_widget_set_device_events" (t_typ @-> Device.t_typ @-> Event_mask.t_list_view @-> returning (void))
let set_direction =
...
let set_font_map =
  foreign "gtk_widget_set_font_map" (t_typ @-> Font_map.t_typ @-> returning (void))
...
let set_parent =
  foreign "gtk_widget_set_parent" (t_typ @-> t_typ @-> returning (void))
let set_parent_window =
  foreign "gtk_widget_set_parent_window" (t_typ @-> Window.t_typ @-> returning (void))
let set_realized =
...
let set_style =
  foreign "gtk_widget_set_style" (t_typ @-> Style.t_typ @-> returning (void))
...
let set_tooltip_window =
  foreign "gtk_widget_set_tooltip_window" (t_typ @-> Window.t_typ @-> returning (void))
let set_valign =
...
let set_visual =
  foreign "gtk_widget_set_visual" (t_typ @-> Visual.t_typ @-> returning (void))
let set_window =
  foreign "gtk_widget_set_window" (t_typ @-> Window.t_typ @-> returning (void))
...
let translate_coordinates self dest_widget src_x src_y =
  let translate_coordinates_raw =
    foreign "gtk_widget_translate_coordinates" (t_typ @-> t_typ @-> int32_t @-> int32_t @-> ptr (int32_t) @-> ptr (int32_t) @-> returning (bool))
  in
...
let unregister_window =
  foreign "gtk_widget_unregister_window" (t_typ @-> Window.t_typ @-> returning (void))
