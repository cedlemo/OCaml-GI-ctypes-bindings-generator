...
val incr_ref:
  t structure ptr -> t structure ptr
val render_icon:
  t structure ptr -> Style.t -> Text_direction.t -> State_type.t -> int32 -> Widget.t -> string option -> Pixbuf.t
val render_icon_pixbuf:
  t structure ptr -> Style_context.t -> int32 -> Pixbuf.t
val render_icon_surface:
  t structure ptr -> Style_context.t -> int32 -> int32 -> Window.t -> Surface.t structure ptr
val unref:
